export const ContriboostFactoryAbi = [
	...
	},
	{
		"inputs": [
			...
			{
				"internalType": "enum ContriboostFactory.PaymentMethod",
				"name": "_paymentMethod",
				"type": "uint8"
			},
			{
		...
		"outputs": [
			{
				...
				"internalType": "struct ContriboostFactory.GoalFundDetails[]",
				"name": "",
				"type": "tuple[]"
			}
		],
